...
def run(
    ...
    *,
    ...
    embedding_url: str
        The url for accessing embedding_model, default is None, which means
        the base_url will be used.
    model: str
    ...
    embedding_client = AsyncOpenAI(
        base_url=base_url if embedding_url is None else embedding_url,
        api_key=api_key,
    )
